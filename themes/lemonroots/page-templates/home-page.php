...
<section id="hero" style="background-image: url(<?php echo get_template_directory_uri() . '/assets/img/AdobeStock_144121574_Preview.jpeg' ?>);">
    <div class="container">
        <h1 class="title">All-in-one <br class="d-lg-none"> Employee Screening</h1>
    ...
    <div class="row">
        <div class="col-12 col-sm-4 col-md-4 col-lg4 col-xl-4">
            <div class="article-container">
                <a href="#">
                    <div class="featured-thumbnail" style="background-image: url(<?php echo get_template_directory_uri() . '/assets/img/article.jpeg' ?>);"></div>
